            ...
            (=>
               ...
               (let
                  ((.1$1_0 c$1_0_old)
                   ...
                   (x.0$2_0 0)
                   (t$2_0 t$2_0_old))
                  (INV_23_MAIN .1$1_0 x.1$1_0 .0$2_0 t$2_0 x.0$2_0)))))))
(assert
   (forall
      ((t$1_0_old Int)
       (c$1_0_old Int)
...
(assert
   (forall
      ((.1$1_0_old Int)
       ...
       (x.0$2_0_old Int))
      (=>
         (INV_23_MAIN .1$1_0_old x.1$1_0_old .0$2_0_old t$2_0_old x.0$2_0_old)
         (let
            ((_$1_9 (< 0 .1$1_0_old)))
            (=>
               (not _$1_9)
                                          ...
                                          (let
                                             ...
                                             (let
                                                ((.0$2_0 _$2_10)
                                                 ...
                                                 (t$2_0 t$2_0_old))
                                                false))))))))
                        (INV_23_MAIN .1$1_0 x.1$1_0 .0$2_0_old t$2_0_old x.0$2_0_old)))))))))
(assert
   (forall
      ((.0$1_0_old Int)
       (x.0$1_0_old Int)
                                          ...
                                          (let
                                             ...
                                             (let
                                                ((.1$1_0 _$1_14)
                                                 (x.1$1_0 _$1_13))
                                                false)))))
                                 (INV_23_MAIN .1$1_0_old x.1$1_0_old .0$2_0 t$2_0 x.0$2_0))))))))))))
(assert
   (forall
      ((.1$1_0_old Int)
       (x.1$1_0_old Int)
               ...
               (let
                  ...
                  (forall
                     ((result$1 Int)
                      (result$2 Int))
                     (and
                        (INV_23_PRE .1$1_0 x.1$1_0 .0$2_0 t$2_0 x.0$2_0)
                        (=>
                           (INV_23 .1$1_0 x.1$1_0 .0$2_0 t$2_0 x.0$2_0 result$1 result$2)
...
(assert
   (forall
      ((.1$1_0_old Int)
       ...
       (x.0$2_0_old Int))
      (=>
         (INV_23_PRE .1$1_0_old x.1$1_0_old .0$2_0_old t$2_0_old x.0$2_0_old)
         (let
            ((_$1_9 (< 0 .1$1_0_old)))
            (=>
               (not _$1_9)
               (let
                  ...
                  (let
                     ...
                     (=>
                        ...
                        (let
                           ((result$2 x.0$2_0_old))
                           (INV_23 .1$1_0_old x.1$1_0_old .0$2_0_old t$2_0_old x.0$2_0_old result$1 result$2))))))))))
(assert
   (forall
      ((.1$1_0_old Int)
       (x.1$1_0_old Int)
            ...
            (=>
               ...
               (let
                  ...
                  (forall
                     ((result$1 Int))
                     (=>
                        (INV_23__1 .1$1_0 x.1$1_0 result$1)
...
(assert
   (forall
      ((.1$1_0_old Int)
       (x.1$1_0_old Int))
      (=>
         (INV_23__1_PRE .1$1_0_old x.1$1_0_old)
         (let
            ((_$1_9 (< 0 .1$1_0_old)))
            (=>
               (not _$1_9)
               (let
                  ...
                  (let
                     ((result$1 x.2$1_0))
                     (INV_23__1 .1$1_0_old x.1$1_0_old result$1))))))))
(assert
   (forall
      ((.1$1_0_old Int)
       (x.1$1_0_old Int))
                     ...
                     (=>
                        ...
                        (forall
                           ((result$1 Int)
                            (result$2 Int))
                           (and
                              (INV_23_PRE .1$1_0 x.1$1_0 .0$2_0_old t$2_0_old x.0$2_0_old)
                              (=>
                                 (INV_23 .1$1_0 x.1$1_0 .0$2_0_old t$2_0_old x.0$2_0_old result$1 result$2)
                                 (INV_23 .1$1_0_old x.1$1_0_old .0$2_0_old t$2_0_old x.0$2_0_old result$1 result$2))))))))))))
(assert
   (forall
      ((.0$1_0_old Int)
                              ...
                              (=>
                                 ...
                                 (forall
                                    ((result$1 Int)
                                     (result$2 Int))
                                    (and
                                       (INV_23_PRE .1$1_0_old x.1$1_0_old .0$2_0 t$2_0 x.0$2_0)
                                       (=>
                                          (INV_23 .1$1_0_old x.1$1_0_old .0$2_0 t$2_0 x.0$2_0 result$1 result$2)
                                          (INV_23 .1$1_0_old x.1$1_0_old .0$2_0_old t$2_0_old x.0$2_0_old result$1 result$2)))))))))))))))
(assert
   (forall
      ((.1$1_0_old Int)
