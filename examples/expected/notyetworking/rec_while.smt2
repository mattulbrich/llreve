                              ...
                              (let
                                 ...
                                 (let
                                    ...
                                    (=>
                                       ...
                                       (let
                                          ((n$2_0 n$2_0_old))
                                          (INV_42_MAIN i.0$1_0 n$1_0 i.0$2_0 n$2_0)))))))))))))))
(assert
   (forall
      ((i.0$1_0_old Int)
       (i.0$2_0_old Int))
      (=>
         (INV_23_MAIN i.0$1_0_old i.0$2_0_old)
         (and
...
(assert
   (forall
      ((i.0$1_0_old Int)
       ...
       (n$2_0_old Int))
      (=>
         (INV_42_MAIN i.0$1_0_old n$1_0_old i.0$2_0_old n$2_0_old)
         (let
            ((_$1_4 (+ i.0$1_0_old 1)))
            (let
               ((i.0$1_0 _$1_4)
                                    ...
                                    (let
                                       ...
                                       (=>
                                          ...
                                          (let
                                             ((n$2_0 n$2_0_old))
                                             false))))))
                           (INV_42_MAIN i.0$1_0 n$1_0 i.0$2_0_old n$2_0_old))))))))))
(assert
   (forall
      ((i.0$1_0_old Int)
       (n$1_0_old Int)
                                    ...
                                    (let
                                       ...
                                       (=>
                                          ...
                                          (let
                                             ((n$1_0 n$1_0_old))
                                             false))))))
                           (INV_42_MAIN i.0$1_0_old n$1_0_old i.0$2_0 n$2_0))))))))))
; end
(assert
   (forall
      ((n$1_0_old Int)
