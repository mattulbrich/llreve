      ...
      (=>
         ...
         (let
            ((i.0$1_0 0)
             ...
             (x.0$2_0 0)
             (n$2_0 n$2_0_old))
            (INV_42_MAIN c$1_0 i.0$1_0 n$1_0 x.0$1_0 i.0$2_0 j.0$2_0 n$2_0 x.0$2_0)))))
(assert
   (forall
      ((c$1_0_old Int)
       (i.0$1_0_old Int)
       ...
       (x.0$2_0_old Int))
      (=>
         (INV_42_MAIN c$1_0_old i.0$1_0_old n$1_0_old x.0$1_0_old i.0$2_0_old j.0$2_0_old n$2_0_old x.0$2_0_old)
         (let
                                             ...
                                             (let
                                                ...
                                                (let
                                                   ((i.0$2_0 _$2_8)
                                                    ...
                                                    (n$2_0 n$2_0_old))
                                                   false)))))))
                              (INV_42_MAIN c$1_0 i.0$1_0 n$1_0 x.0$1_0 i.0$2_0_old j.0$2_0_old n$2_0_old x.0$2_0_old)))))))))))
(assert
   (forall
      ((c$1_0_old Int)
       (i.0$1_0_old Int)
                                             ...
                                             (let
                                                ...
                                                (let
                                                   ((i.0$1_0 _$1_8)
                                                    ...
                                                    (n$1_0 n$1_0_old))
                                                   false)))))))
                              (INV_42_MAIN c$1_0_old i.0$1_0_old n$1_0_old x.0$1_0_old i.0$2_0 j.0$2_0 n$2_0 x.0$2_0)))))))))))
(assert
   (forall
      ((c$1_0_old Int)
       (i.0$1_0_old Int)
