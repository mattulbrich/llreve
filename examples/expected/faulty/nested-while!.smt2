      ...
      (=>
         ...
         (let
            ((i.0$1_0 0)
             ...
             (.01$2_0 g$2_0_old)
             (.0$2_0 x$2_0_old))
            (INV_42_MAIN .0$1_0 .01$1_0 i.0$1_0 .0$2_0 .01$2_0 i.0$2_0)))))
(assert
   (forall
      ((.1$1_0_old Int)
       (.12$1_0_old Int)
       ...
       (_$2_5_old Int))
      (=>
         (INV_23_MAIN .1$1_0_old .12$1_0_old _$1_5_old .1$2_0_old .12$2_0_old _$2_5_old)
         (let
                           ...
                           (let
                              ...
                              (let
                                 ((.12$2_0 _$2_13)
                                  (.1$2_0 _$2_12)
                                  (_$2_5 _$2_5_old))
                                 (INV_23_MAIN .1$1_0 .12$1_0 _$1_5 .1$2_0 .12$2_0 _$2_5))))))))))))
(assert
   (forall
      ((.1$1_0_old Int)
       (.12$1_0_old Int)
...
(assert
   (forall
      ((.0$1_0_old Int)
       ...
       (i.0$2_0_old Int))
      (=>
         (INV_42_MAIN .0$1_0_old .01$1_0_old i.0$1_0_old .0$2_0_old .01$2_0_old i.0$2_0_old)
         (let
                                    ...
                                    (let
                                       ...
                                       (let
                                          ((.12$2_0 _$2_13)
                                           ...
                                           (_$2_5 _$2_5_old))
                                          false)))))
                           (INV_23_MAIN .1$1_0 .12$1_0 _$1_5 .1$2_0_old .12$2_0_old _$2_5_old))))))))))
(assert
   (forall
      ((.1$1_0_old Int)
       (.12$1_0_old Int)
                                    ...
                                    (let
                                       ...
                                       (let
                                          ((.12$1_0 _$1_15)
                                           ...
                                           (_$1_5 _$1_5_old))
                                          false))))))
                        (INV_23_MAIN .1$1_0_old .12$1_0_old _$1_5_old .1$2_0 .12$2_0 _$2_5)))))))))
; end
(assert
   (forall
      ((x$1_0_old Int)
...
(assert
   (forall
      ((.1$1_0_old Int)
       ...
       (_$1_5_old Int))
      (=>
         (INV_23__1_PRE .1$1_0_old .12$1_0_old _$1_5_old)
         (let
            ((_$1_9 (< .1$1_0_old _$1_5_old)))
            (=>
               _$1_9
...
(assert
   (forall
      ((.0$1_0_old Int)
       ...
       (i.0$1_0_old Int))
      (=>
         (INV_42__1_PRE .0$1_0_old .01$1_0_old i.0$1_0_old)
         (let
            ((_$1_1 (< i.0$1_0_old .0$1_0_old)))
            (=>
               (not _$1_1)
...
(assert
   (forall
      ((.1$2_0_old Int)
       ...
       (_$2_5_old Int))
      (=>
         (INV_23__2_PRE .1$2_0_old .12$2_0_old _$2_5_old)
         (let
            ((_$2_8 (< .1$2_0_old _$2_5_old)))
            (=>
               _$2_8
...
(assert
   (forall
      ((.0$2_0_old Int)
       ...
       (i.0$2_0_old Int))
      (=>
         (INV_42__2_PRE .0$2_0_old .01$2_0_old i.0$2_0_old)
         (let
            ((_$2_1 (< i.0$2_0_old .0$2_0_old)))
            (=>
               (not _$2_1)
